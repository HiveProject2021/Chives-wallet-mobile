...
class WalletTool:
    ...
    async def  push_transaction(self):           
        ...
        CHIVES_WALLET_CLI_LOCKING = r.hget("CHIVES_WALLET_CLI_LOCKING","CAT_chia_wallet_v3.py")
        ...
        if CHIVES_WALLET_CLI_LOCKING == 0:            
            r.hset("CHIVES_WALLET_CLI_LOCKING","CAT_chia_wallet_v3.py", int(time.time()) )    
        ...
        CHIVES_WALLET_TX_DOING_CHIVES = r.hgetall("CHIVES_WALLET_TX_DOING_ASSET_TOKEN_CHIA")
        ...
        for ORDER_KEY,ORDER_KEY_STATUS in CHIVES_WALLET_TX_DOING_CHIVES.items():
            if ORDER_KEY_STATUS == bytes("READY","ascii"):
                print('===================')
                print(ORDER_KEY)
                TODO_ORDER = r.hget("CHIVES_WALLET_TX_ASSET_TOKEN_CHIA",ORDER_KEY)
                #print('===================')
                #print(TODO_ORDER)
                ...
                if TODO_ORDER_64 is None:
                    ...
                    #TODO_ORDER = r.hset("CHIVES_WALLET_TX_DOING_ASSET_TOKEN_CHIA",ORDER_KEY,TODO_ORDER_JSON['TX_STATUS'])
                    #TODO_ORDER = r.hset("CHIVES_WALLET_TX_ASSET_TOKEN_CHIA",ORDER_KEY,TODO_ORDER_64_TEXT)
                else:
                    #开始处理发送TOKEN的工作
                    ...
                    if CurrentCoinAmount<SendToAmountAll:
                        ...
                        TODO_ORDER_JSON['TX_TIME'] 			    = int(time.time());
                        TODO_ORDER_JSON['TX_PATH'] 			    = "CAT_chia_wallet_v3.py";
                        ...
                        #print(TODO_ORDER_JSON_TEXT)
                        #print(TODO_ORDER_64_TEXT)
                        r.hset("CHIVES_WALLET_TX_DOING_ASSET_TOKEN_CHIA",ORDER_KEY,TODO_ORDER_JSON['TX_STATUS'])
                        r.hset("CHIVES_WALLET_TX_ASSET_TOKEN_CHIA",ORDER_KEY,TODO_ORDER_64_TEXT)                        
        ...
        #把时间设置为0,取消LOCK
        r.hset("CHIVES_WALLET_CLI_LOCKING","CAT_chia_wallet_v3.py", 0 )        
        #关闭数据库
