...
class WalletTool:
    ...
    async def  push_transaction(self):           
        ...
        CHIVES_WALLET_TX_DOING_CHIVES = r.hgetall("CHIVES_WALLET_TX_DOING_CHIVES-KITTY")
        ...
        for ORDER_KEY,ORDER_KEY_STATUS in CHIVES_WALLET_TX_DOING_CHIVES.items():
            if ORDER_KEY_STATUS == bytes("READY","ascii"):
                print('===================')
                print(ORDER_KEY)
                TODO_ORDER = r.hget("CHIVES_WALLET_TX_CHIVES-KITTY",ORDER_KEY)
                #print('===================')
                #print(TODO_ORDER)
                ...
                if TODO_ORDER_64 is None:
                    ...
                    #TODO_ORDER = r.hset("CHIVES_WALLET_TX_DOING_CHIVES-KITTY",ORDER_KEY,TODO_ORDER_JSON['TX_STATUS'])
                    #TODO_ORDER = r.hset("CHIVES_WALLET_TX_CHIVES-KITTY",ORDER_KEY,TODO_ORDER_64_TEXT)
                else:
                    #开始处理发送TOKEN的工作
                    ...
                    AllPuzzleHashArray = []
                    i = 0
                    for PUZZLE_HASH,SUB_KEY_ARRAY in TODO_ORDER_JSON['WALLET_DETAIL'].items():
                        ...
                        puzzlehash = SUB_KEY_ARRAY['puzzlehash']
                    ...
                    if CurrentCoinAmount<SendToAmountAll:
                        ...
                        #print(TODO_ORDER_JSON_TEXT)
                        #print(TODO_ORDER_64_TEXT)
                        r.hset("CHIVES_WALLET_TX_DOING_CHIVES-KITTY",ORDER_KEY,TODO_ORDER_JSON['TX_STATUS'])
                        r.hset("CHIVES_WALLET_TX_CHIVES-KITTY",ORDER_KEY,TODO_ORDER_64_TEXT)                        
